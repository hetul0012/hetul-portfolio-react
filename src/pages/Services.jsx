          ...
          <div className="service-row custom_row">
            <div className="custom_col">
              <div className="service-img">
                <img src="/src/assets/front-development.png" alt="UX/UI" />
              </div>
              <h2 className="service-sub-title">UX/UI Design</h2>
              <p className="service-detail">
                We provide expert UI/UX design services to produce digital experiences that are responsive,
            ...
            <div className="custom_col">
              <div className="service-img">
                <img src="/src/assets/web-design.png" alt="Web Design" />
              </div>
              <h2 className="service-sub-title">Web Design</h2>
              <p className="service-detail">
                We offer cutting-edge, responsive web design services to produce aesthetically pleasing,
                intuitive, and effective websites.
              </p>
            </div>
  
            <div className="custom_col">
              <div className="service-img">
                <img src="/src/assets/coding.png" alt="Web Development" />
              </div>
